...
path="E:/Workspace/NL/ABAQUS/JOINt/Ibeam/"
...
#    timePeriod=60000.0, maxNumInc=100, timeIncrementationMethod=FIXED,
#    initialInc=600.0, noStop=OFF, nlgeom=ON)
###########Modify the steps
mdb.models['topo'].steps['Step-1'].setValues(timePeriod=60000.0, maxNumInc=100, timeIncrementationMethod=FIXED,initialInc=600.0, noStop=OFF, nlgeom=ON)
...
leaf = dgo.LeafFromElementSets(elementSets=('PART-1-1.WEB', ))
#display the WEB
