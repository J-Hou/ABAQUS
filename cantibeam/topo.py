...
mdb.models['topo'].ConcentratedForce(name='Load-1',createStepName='Step-1',region=region,cf1=0,cf2=-96000.0)
nodes1 = n1[80:101]
...
##run the analysis
###########################################
mdb.Job(name='Job-'+str(iter), model='topo', description='', type=ANALYSIS, atTime=None,
